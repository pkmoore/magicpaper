...
are highly relevant to the modern information security field and offer a wide
range of complexity.  Our hope was to illustrate how card magic can be used
successfully to each anything from simple deceptive scenarios to complicated
...
with a small amount of influence can compromise a
system.
